...
sys.path.append("../../../libero-env/LIBERO-original")
sys.path.append("../../")

relative_new_path = "../../../libero-env/LIBERO-original"
relative_config_path = "../../../libero-env/LIBERO-original/libero/"
...
class GenerateConfig:
    ...
    local_log_dir: str = "./results/logs"            # Local directory for eval logs
...
def setup_logging(cfg: GenerateConfig):
    ...
    local_log_filepath = os.path.join(cfg.local_log_dir, "LIBERO-original", "logs", run_id + ".txt")
...
def prepare_save_dirs(cfg: GenerateConfig):
    ...
    task_suite_name = get_task_suite_name(cfg)
    save_dirs = {
        "trajectory_root": save_root / "LIBERO-original" / "trajectories" / task_suite_name / cfg.save_tag,
        "rollout_root": save_root / "LIBERO-original" / "rollouts" / task_suite_name / cfg.save_tag,
        "metrics": save_root / "LIBERO-original" / "metrics" / task_suite_name / cfg.save_tag,
    }
